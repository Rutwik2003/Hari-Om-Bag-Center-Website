  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
		...
		<div class="mr-5"><b>Add Product</b></div>
		</div>
		<a class="card-footer text-white clearfix small z-1" href="admin-add-product.php">
		<span class="float-left">Add New Product</span>
		<span class="float-right">
		<i class="fa fa-angle-right"></i>
		</span>
		</a>
